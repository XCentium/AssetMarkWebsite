...
var CommGallery = {
	...
	*/
	...
	// the list of photos
	galleryPhotos : [
		{ photo: 'give_back1_500.ashx', thumb: 'tn-give_back1.ashx', copy: 'Building houses with Habitat for Humanity' },
		{ photo: 'give_back2_500.ashx', thumb: 'tn-give_back2.ashx', copy: 'Volunteering at a local food bank' },
		{ photo: 'give_back3_500.ashx', thumb: 'tn-give_back3.ashx', copy: 'Volunteering at a local food bank' },
		{ photo: 'community3.ashx', thumb: 'tn-community3.ashx', copy: 'Bike the Bridges benefitting Special Olympics' }
	],

	config : {
	    photoDir: '/~/media/Assetmark/Images/Community/',
		thumbsShown: 5
	},
...
$(function() {
		...
		var menus = ['people', 'together', 'practice'];
		var selectedMenu = "";
        ...
        // Go to the page rather than display a sub-menu.
        if (thisMenu === 'practice') {
          document.location.href = $('#nav-main-practice a').attr('href');
          return true;
        }
...
$(function() {
		...
		var showHideExecs = function(show) {
			...
			$('#our-people-exec-widget').attr('src', '/~/media/Assetmark/Images/people/execs/' + (show ? 'arrow-blue-down.ashx' : 'arrow-blue-up.ashx'));
...
var Hero = {
	...
	animateNext: function () {
	    //console.log('Hero.animated:' + Hero.animated);
	    //console.log('Hero.currentSlide:' + Hero.currentSlide);
	    //console.log('Hero.totalSlides:' + Hero.totalSlides);
	    //console.log('Hero.config.stopAfterLoop:' + Hero.config.stopAfterLoop);
	    //console.log('Hero.currentPage:' + Hero.currentPage);
	    //console.log('------');
	    if (Hero.animated) {
	        if (Hero.currentSlide == Hero.totalSlides) {
	            Hero.currentPage++;
	        }

	        if (Hero.config.stopAfterLoop > 0 && Hero.config.stopAfterLoop == Hero.currentPage) {
	            Hero.animationStop();
	        }
...
$(document).ready(function(){
    ...
    $('.modalLink').modal({
        ...
        animationSpeed: 150,            // speed of overlay in milliseconds | default=400
        moveModalSpeed: 'slow',         // speed of modal movement when window is resized | slow or fast | default=false
        background: 'abc8e8',           // hexidecimal color code - DONT USE #
