    ...
    initialize: function (model) {
        ...
        if (model.Columns) {
            $.each(model.Columns, function (index, column) {
                ...
                colModel[index] = {
                    ...
                    formatter: eval(column.Formatter),
        ...
        var options = {
            ...
            onRowClick: model.RowClickUrl ? [function (rowid, e) {
                $('<form method="post" action="' + model.RowClickUrl + '"><input type="hidden" name="id" value="' + rowid + '" /></form>"')
					.appendTo("body").submit();
            } ] : []
        };

        if (model.DataType)
            options.datatype = (model.DataType === 1 ? "json" : "xml");
        ...
        if (model.NoResultsText)
            options.noResultsText = model.NoResultsText;
        ...
        if (model.SubgridColumns) {
            $.each(model.SubgridColumns, function (index, column) {
                ...
                subGridMapping[index] = column.Name;
            });
...
// Add formatters to this global object as needed
var GridFormatters = {};

// TODO: remove temporary preloading when something better is in place
(new Image()).src = "/Shared/Images/gridRowSelectedBackground.png";
(new Image()).src = "/Shared/Images/gridRowExpanded.png";
(new Image()).src = "/Shared/Images/globals_spinner_yellow.gif";
(new Image()).src = "/Shared/Images/gridHeader_arrow_up.png";
(new Image()).src = "/Shared/Images/gridHeader_arrow_down.png";
(new Image()).src = "/Shared/Images/gridSubgridHeaderBackground.png";
(new Image()).src = "/Shared/Images/gridTotalsBackground.png";
(new Image()).src = "/Shared/Images/gridTotalsDataBackground.png";
(new Image()).src = "/Shared/Images/gridLoader.gif";
