function SolutionFinder() {
	...
	var openQuestion = function() {
		...
		if(model.investment_amount === '25k' || model.investment_amount === '100k') {
			$('.goal_one .preserve_wealth').css('background-image','url("../img/solution-finder/goal_bg_grey.png")');
			$('.goal_one .preserve_wealth').css('cursor','default');
		}

		// 25k conditions
		if(model.investment_amount === '25k' && model.goal === 'enhance_income') {
			$('.risk1').css('background-image','url("../img/solution-finder/risk_bg_grey.png")');
			$('.risk5').css('background-image','url("../img/solution-finder/risk_bg_grey.png")');
		...
		if(model.investment_amount === '250k' && model.goal === 'enhance_income') {
			...
			$('.risk2').css('background-image','url("../img/solution-finder/risk_bg_grey.png")');
			$('.risk3').css('background-image','url("../img/solution-finder/risk_bg_grey.png")');
			$('.risk4').css('background-image','url("../img/solution-finder/risk_bg_grey.png")');
			$('.risk5').css('background-image','url("../img/solution-finder/risk_bg_grey.png")');
	...
	var showResults = function() {
		...
		for (i=0; i<len; i++) {
			...
			$('.results_container').append('' +
				...
				'<h4>Asset Allocation Approaches</h4>' +
				'<img src="../img/solution-finder/' + productName.replace(/ /g, '_') + '_'+model.risk_profile+'.gif" />' +
	...
	var plan_data = {
		'GPS Select Accumulation': {
			...
			profiles: '2-5',
			link: '../gps-select-solutions/accumulation.html',
			disclaimer:''
		},
		'GPS Select Accumulation Plus': {
			...
			profiles: '2-5',
			link: '../gps-select-solutions/accumulation-plus.html',
			disclaimer:''
		},
		'GPS Select Retirement Income': {
			...
			profiles: '2-4',
			link: '../gps-select-solutions/retirement-income.html',
		...
		'GPS Select Wealth Preservation': {
			...
			profiles: '1',
			link: '../gps-select-solutions/wealth-preservation.html',
			disclaimer:''
		},
		'GPS Select Tactical Advantage': {
			...
			profiles: '2-5',
			link: '../gps-select-solutions/tactical-advantage.html',
			disclaimer:''
		},
		'GPS Select Low Volatility': {
			...
			profiles: '1',
			link: '../gps-select-solutions/low-volatility.html',
			disclaimer:''
		},
		'GPS Select Multi-Asset Income': {
			...
			profiles: '2-4',
			link: '../gps-select-solutions/multi-asset-income.html',
			disclaimer:'Multi-asset income strategies comprise 100% of the Strategic, Tactical Constrained and Tactical Unconstrained portions of the portfolio.'
		},
		'GPS Accumulation of Wealth': {
			...
			profiles: '1-5',
			link: '../gps-solutions/accumulation.html',
			disclaimer:''
		},
		'GPS Distribution of Wealth': {
			...
			profiles: '2-4',
			link: '../gps-solutions/distribution.html',
		...
		'GPS Tactical Unconstrained and Absolute Return': {
			...
			profiles: '2-4',
			link: '../gps-solutions/tactical.html',
			disclaimer:''
		},
		'GPS Multi-Asset Income': {
			...
			profiles: '2-4',
			link: '../gps-solutions/multi-asset.html',
