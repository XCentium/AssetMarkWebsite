...
(function () {
    ...
    R.type = (win.SVGAngle || doc.implementation.hasFeature("https://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") ? "SVG" : "VML");
    if (R.type == "VML") {
    ...
    // SVG
    if (R.svg) {
        paperproto.svgns = "https://www.w3.org/2000/svg";
        paperproto.xlink = "https://www.w3.org/1999/xlink";
        round = function (num) {
