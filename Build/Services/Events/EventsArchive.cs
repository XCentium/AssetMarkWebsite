...
{
    public class EventsArchive : EventsBase
    {
        ...
        {
            oSearch.SetDateFilter(DateTime.MinValue, DateTime.Today.AddDays(-1), isDefault: true);
        }

        protected override void SetSearchDateRange()
        {
            oSearch.SetDateFilter(DateTime.MinValue, DateTime.Today.AddDays(-1), isDefault: false);
        }

        public const string CODE = Constants.Event.SearchType.Archive;//"events-archive";
            ...
            return new List<KeyValuePair<string, string>>()
                    {
                        ...
                        new KeyValuePair<string,string>("Type","eventtype"),
                        new KeyValuePair<string,string>("View Archive","archiveUrl,url,by_invitation_only_text")
                    };
        }
