...
{
    public abstract class AgentTimeRangeTaskBase
    {
        ...
        protected bool IsValidDateRange
        {
            get
            {
                if (isValidDateRange == null)
                {
                    ValidateTimeWindow();
                }
                return isValidDateRange.GetValueOrDefault();
            }
        }
        ...
        private string className = "Genworth.SitecoreExt.ScheduledTasks.TimeRangeTaskBase";

        public AgentTimeRangeTaskBase(string className)
        {
