...
{
    public class DocumentAllocationApproachId : Sitecore.ContentSearch.ComputedFields.IComputedIndexField
    {
        ...
        public object ComputeFieldValue(Sitecore.ContentSearch.IIndexable indexable)
        {
            ...
            string allocationApproachId = null;
            ...
            foreach (Item parentItem in parentItems)
            {
                if (parentItem.InstanceOfTemplate(Constants.Investments.Templates.Strategy))
                {
                    ...
                    {
                        allocationApproachId = allocationApproachItem.ID.ToString();
                    }
                }
                else if (parentItem.InstanceOfTemplate(Constants.Investments.Templates.AllocationApproach))
                {
                    allocationApproachId = parentItem.ID.ToString();
                }
            }

            return allocationApproachId;
        } 
    }
}
