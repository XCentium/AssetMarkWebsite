...
{
    public class DocumentSolutionType : Sitecore.ContentSearch.ComputedFields.IComputedIndexField
    {
        ...
        public object ComputeFieldValue(Sitecore.ContentSearch.IIndexable indexable)
        {
            ...
            {
                var titles = IndexingUtility.GetMultilistValues(field, "Title");
                solutionTypes = titles;
            }
